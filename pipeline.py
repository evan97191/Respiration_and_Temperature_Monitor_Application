...
from analysis.respiration import calculate_respiration_fft, calculate_fft_raw
...
class MonitorPipeline:
    def __init__(self):
        ...
        self.display_manager = DisplayManager(active_windows, default_width=config.DISPLAY_WIDTH, default_height=config.DISPLAY_HEIGHT)
            ...
            if config.SKIN_COLOR_FILTER:
                ...
                if skin_temperatures.size > 0:
                    ...
                    skin_masked_thermal_data = cv2.addWeighted(
                        thermal_roi_8bit, 1 - alpha, color_overlay, alpha, 0
                    )
